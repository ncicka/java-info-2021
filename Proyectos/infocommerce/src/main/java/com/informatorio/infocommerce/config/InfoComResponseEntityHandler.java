package com.informatorio.infocommerce.config;

import com.informatorio.infocommerce.dto.ApiError;
...
@ControllerAdvice
public class InfoComResponseEntityHandler extends ResponseEntityExceptionHandler{
